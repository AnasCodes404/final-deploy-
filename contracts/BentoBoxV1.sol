/**
 *Submitted for verification at ftmscan.com on 2021-03-23
*/
...
contract BentoBoxV1 is MasterContractManager, BoringBatchable, ReentrancyGuard {
    using BoringMath for uint256;
    using BoringMath128 for uint128;
    ...
    uint256 amount,
    uint256 share
) public allowed(from) nonReentrant returns (uint256 amountOut, uint256 shareOut) {
    // Checks
